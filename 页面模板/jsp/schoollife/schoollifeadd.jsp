  ...
  <div class="col-md-12 col-sm-12 col-xs-12">
    <div class="x_panel">
	  ...
	  <!-- <div class="item form-group">
           ...
           <div class="clearfix"></div>
        <form class="form-horizontal form-label-left" action="${pageContext.servletContext.contextPath}/schoollife/addsave.html" method="post" enctype="multipart/form-data">
          <div class="item form-group">
          ...
          <div class="item form-group">
            ...
            <div class="col-md-6 col-sm-6 col-xs-12">
              <textarea id="appInfo" name="content"     required="required"
              placeholder="请输入本校园生活的相关信息，本信息作为人物的的详细信息进行人物的介绍。" class="form-control col-md-7 col-xs-12"></textarea>
            </div>
          </div>
           <div class="item form-group">
